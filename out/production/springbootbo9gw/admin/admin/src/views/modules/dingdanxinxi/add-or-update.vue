<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'" label="物流单号" prop="wuliudanhao">
					<el-input v-model="ruleForm.wuliudanhao" placeholder="物流单号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.wuliudanhao" label="物流单号" prop="wuliudanhao">
					<el-input v-model="ruleForm.wuliudanhao" placeholder="物流单号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="物品名称" prop="wupinmingcheng">
					<el-input v-model="ruleForm.wupinmingcheng" placeholder="物品名称" clearable  :readonly="ro.wupinmingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="物品名称" prop="wupinmingcheng">
					<el-input v-model="ruleForm.wupinmingcheng" placeholder="物品名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="select" v-if="type!='info'"  label="物流类型" prop="wuliuleixing">
					<el-select :disabled="ro.wuliuleixing" v-model="ruleForm.wuliuleixing" placeholder="请选择物流类型" >
						<el-option
							v-for="(item,index) in wuliuleixingOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="物流类型" prop="wuliuleixing">
					<el-input v-model="ruleForm.wuliuleixing"
						placeholder="物流类型" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="select" v-if="type!='info'" label="重量" prop="zhongliang">
					<el-select :disabled="ro.zhongliang" @change="zhongliangChange" v-model="ruleForm.zhongliang" placeholder="请选择重量">
						<el-option
							v-for="(item,index) in zhongliangOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.zhongliang" label="重量" prop="zhongliang">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="收件人" prop="shoujianren">
					<el-input v-model="ruleForm.shoujianren" placeholder="收件人" clearable  :readonly="ro.shoujianren"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="收件人" prop="shoujianren">
					<el-input v-model="ruleForm.shoujianren" placeholder="收件人" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="联系电话" prop="lianxidianhua">
					<el-input v-model="ruleForm.lianxidianhua" placeholder="联系电话" clearable  :readonly="ro.lianxidianhua"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="联系电话" prop="lianxidianhua">
					<el-input v-model="ruleForm.lianxidianhua" placeholder="联系电话" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="收件地址" prop="shoujiandizhi">
					<el-input v-model="ruleForm.shoujiandizhi" placeholder="收件地址" clearable  :readonly="ro.shoujiandizhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="收件地址" prop="shoujiandizhi">
					<el-input v-model="ruleForm.shoujiandizhi" placeholder="收件地址" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="下单时间" prop="xiadanshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.xiadanshijian" label="下单时间" prop="xiadanshijian">
...
export default {
	...
	methods: {
		...
		init(id,type) {
            ...
            this.$http({
				url: `option/shoufeibiaozhun/zhongliang`,
				method: "get"
            }).then(({ data }) => {
				if (data && data.code === 0) {
					this.zhongliangOptions = data.data;
				} else {
					this.$message.error(data.msg);
				}
            });
			...
			zhongliangChange () {
				this.$http({
					url: `follow/shoufeibiaozhun/zhongliang?columnValue=`+ this.ruleForm.zhongliang,
					method: "get"
				}).then(({ data }) => {
					if (data && data.code === 0) {
